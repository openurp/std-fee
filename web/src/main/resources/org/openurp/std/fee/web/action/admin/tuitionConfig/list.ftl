...
[@b.head/]
  [@b.grid items=tuitionConfigs var="tuitionConfig"]
    ...
    [@b.row]
      ...
      [@b.col title="院系所" property="department.name" width="15%"]${(tuitionConfig.department.name)!"--"}[/@]
      [@b.col title="专业" property="major.name" width="20%"]${(tuitionConfig.major.name)!"--"} ${(tuitionConfig.direction.name)!}[/@]
