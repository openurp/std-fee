...
<table class="infoTable" style="width:90%;margin:10px auto auto;">
  ...
  <tr>
    ...
    <td[#if bill.amount?default(0) lt 0] style="color: red"[/#if]>${((bill.amount/100.0)?string("0.00#"))!}元</td>
    <td class="title">缴费金额：</td>
    <td[#if bill.payed?default(0) lt 0] style="color: red"[/#if]>${((bill.payed/100.0)?string("0.00#"))!}元</td>
  </tr>
  <tr>
